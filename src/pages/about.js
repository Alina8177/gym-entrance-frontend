...
const About = () => {
  return (
    <div
      ...
      <p style={{ fontSize: '25px'}}>Hi, we’re Blink Fitness, and we believe that exercise isn’t just about how it makes you look, but also how it makes you feel. Blink is a motivating space with a staff of mood-lifters. We take pride in challenging fitness industry norms and celebrating every unique body.</p>
      </div>
    </div>
  );
};
